...
# ==========================================
# 🤖 8. Model Building (Random Forest + XGBoost)
# ==========================================
...
print(f"\n💡 Insight: Only {fraud_rate:.3f}% transactions are fraudulent!")
...
A: Choose threshold by business cost — weigh cost of false negatives vs false positives.
